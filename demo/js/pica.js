/* pica 1.0.7 nodeca/pica */ !function (e) { if ("object" == typeof exports && "undefined" != typeof module)
    module.exports = e();
else if ("function" == typeof define && define.amd)
    define([], e);
else {
    var f;
    "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.pica = e();
} }(function () {
    ...
    return (function e(t, n, r) { function s(o, u) { if (!n[o]) {
        ...
        s(r[o]); return s; })({ "./": [function (require, module, exports) {
                'use strict';
                /*Layers window:true*/
                ...
                function resizeBuffer(options, callback) {
                    ...
                    if (WORKER && exports.WW) {
                        ...
                        wr.onmessage = function (ev) {
                            var i, l, dest = options.dest, output = ev.data.output;
                ...
                function resizeCanvas(from, to, options, callback) {
                    var w = from.width, h = from.height, w2 = to.width, h2 = to.height;
                ...
                function blur(src, srcW, srcH /*, radius*/) {
                    var x, y, output = new Uint16Array(src.length);
                    for (x = 0; x < srcW; x++) {
                        for (y = 0; y < srcH; y++) {
                ...
                function createFilters(quality, srcSize, destSize) {
                    ...
                    var destPixel, srcPixel, srcFirst, srcLast, filterElementSize, floatFilter, fxpFilter, total, fixedTotal, pxl, idx, floatVal, fixedVal;
                ...
                function resize(options) {
                    ...
                    var filtersX = createFilters(quality, srcW, destW), filtersY = createFilters(quality, srcH, destH);
                ...
                module.exports = function (fn) {
                    ...
                    var src = '(' + bundleFn + ')({'
                        ...
                        + '},{},[' + stringify(skey) + '])';
                    return new Worker(window.URL.createObjectURL(new Blob([src], { type: 'text/javascript' })));
                };
            }, {}] }, {}, [])("./");
});
