...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", "./f2t"], factory);
    }
})(function (require, exports) {
    "use strict";
    var f2t_1 = require("./f2t");
    /**
     * can be used to graph loss, or accurate over time
     */
    var GraphBase = (function () {
        function GraphBase(options) {
        ...
        GraphBase.prototype.drawBorders = function (W, H, ctx) {
            var pad = 25;
            ...
            for (var i = 0; i <= ng; i++) {
                ...
                ctx.fillText(f2t_1.f2t(i / ng * this.step_horizon / 1000) + 'k', xPos, H - pad + 14);
            }
            for (var i = 0; i <= ng; i++) {
                var yPos = i / ng * (H - 2 * pad) + pad;
                ctx.moveTo(pad, yPos);
                ctx.lineTo(W - pad, yPos);
                ctx.fillText(f2t_1.f2t((ng - i) / ng * (this.maxy - this.miny) + this.miny), 0, yPos);
            }
            ctx.stroke();
        };
        return GraphBase;
