import {float as randf, integer as randi} from './utility/Random';
...
(function(global)
{
	...
	const maxmin = global.maxmin;
	const randperm = global.randperm;
	const weightedSample = global.weightedSample;
	const getopt = global.getopt;
	const arrUnique = global.arrUnique;
